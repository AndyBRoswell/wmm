...
namespace TinyRandom {
    ...
    namespace String {
        std::uniform_int_distribution<qsizetype> uniform_ucase_latin_dist('A', 'Z');
        std::uniform_int_distribution<qsizetype> uniform_lcase_latin_dist('a', 'z');
        std::uniform_int_distribution<qsizetype> uniform_dec_digit_dist('0', '9');
    }
}
